...
public struct MonthlyTrendData: Sendable {
    ...
    public let currentMonthLPH: Double      // MTD lines/hour
    public let previousMonthLPH: Double     // Previous month same-period lines/hour
    public let percentageChange: Double?    // nil if no previous data
